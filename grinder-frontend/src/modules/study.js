...
const [UPDATE_STUDYTIME,UPDATE_STUDYTIME_SUCCESS,UPDATE_STUDYTIME_FAILURE] =createRequestActionTypes('study/UPDATE_STUDYTIME');
...
export const updateStudyTime = createAction(UPDATE_STUDYTIME,studyingInfo=>studyingInfo);

const updateStudyTimeSaga = createRequestSaga(UPDATE_STUDYTIME,studyAPI.updateStudyTime);
