...
const [READ_SETTINGS,READ_SETTINGS_SUCCESS,READ_SETTINGS_FAILURE] = createRequestActionTypes('settings/READ_SETTINGS');
const [ADD_CATEGORY,ADD_CATEGORY_SUCCESS,ADD_CATEGORY_FAILURE] = createRequestActionTypes('settings/ADD_CATEGORY');
const [DELETE_CATEGORY,DELETE_CATEGORY_SUCCESS,DELETE_CATEGORY_FAILURE] = createRequestActionTypes('settings/DELETE_CATEGORY');

export const changeCategoryInput = createAction(CHANGE_CATEGORY_INPUT,({key,value}) =>({
    key,
    value
}));
...
export const deleteCategory = createAction(DELETE_CATEGORY,({id,categoryId})=>({
    id,
    categoryId,
}));

const readSettingsSaga = createRequestSaga(READ_SETTINGS,settingsAPI.readSettings);
const addCategorySaga = createRequestSaga(ADD_CATEGORY,settingsAPI.addCategory);
const deleteCategorySaga = createRequestSaga(DELETE_CATEGORY,settingsAPI.deleteCategory);
