...
const [READ_OVERVIEW_PLAN,READ_OVERVIEW_PLAN_SUCCESS,READ_OVERVIEW_PLAN_FAILURE] = createRequestActionTypes('overview/READ_OVERVIEW_PLAN');
const [READ_OVERVIEW_CHART,READ_OVERVIEW_CHART_SUCCESS,READ_OVERVIEW_CHART_FAILURE] = createRequestActionTypes('overview/READ_OVERVIEW_CHART');
...
const readOverviewPlanSaga = createRequestSaga(READ_OVERVIEW_PLAN,overviewAPI.readOverviewPlan);
const readOverviewChartSaga = createRequestSaga(READ_OVERVIEW_CHART,overviewAPI.readOverviewChart);
