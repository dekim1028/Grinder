...
const [
	READ_CHECKLIST,
	READ_CHECKLIST_SUCCESS,
	READ_CHECKLIST_FAILURE,
] = createRequestActionTypes('checklist/READ_CHECKLIST');
...
] = createRequestActionTypes('checklist/ADD_CHECKLIST_ITEM');
const [
	UPDATE_CHECKLIST_ITEM,
	UPDATE_CHECKLIST_ITEM_SUCCESS,
	UPDATE_CHECKLIST_ITEM_FAILURE,
] = createRequestActionTypes('checklist/UPDATE_CHECKLIST_ITEM');
const [
	DELETE_CHECKLIST_ITEM,
	DELETE_CHECKLIST_ITEM_SUCCESS,
	DELETE_CHECKLIST_ITEM_FAILURE,
] = createRequestActionTypes('checklist/DELETE_CHECKLIST_ITEM');

export const readChecklist = createAction(READ_CHECKLIST, (id) => id);
export const setUpdateTarget = createAction(
	SET_UPDATE_TARGET,
	(target) => target,
);
export const changeUpdateTarget = createAction(
	CHANGE_UPDATE_TARGET,
	({ key, value }) => ({
		key,
		value,
	}),
...
const addChecklistItemSaga = createRequestSaga(
	ADD_CHECKLIST_ITEM,
	checklistAPI.addChecklistItem,
);
const updateChecklistItemSaga = createRequestSaga(
	UPDATE_CHECKLIST_ITEM,
	checklistAPI.updateChecklistItem,
);
const deleteChecklistItemSaga = createRequestSaga(
	DELETE_CHECKLIST_ITEM,
	checklistAPI.deleteChecklistItem,
);
