...
const [READ_PLANNER,READ_PLANNER_SUCCESS,READ_PLANNER_FAILURE] = createRequestActionTypes('planner/READ_PLANNER');
const [UPDATE_PLANNER,UPDATE_PLANNER_SUCCESS,UPDATE_PLANNER_FAILURE] = createRequestActionTypes('planner/UPDATE_PLANNER');
...
export const readPlanner = createAction(READ_PLANNER,({date})=>({
    date,
}));
...
const updatePlannerSaga = createRequestSaga(CHANGE_FILED,plannerAPI.update);
