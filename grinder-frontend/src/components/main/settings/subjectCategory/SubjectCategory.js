...
const SubjectCategory = ({sketchPicker,settings,categoryInput,handleClick,handleChangeComplete,onChange,onSubmit,onDelete}) => {
    return (
        <>
            <InputBlock onSubmit={onSubmit}>
                <InputBox>
                    ...
                    <input type="text" className="subjectInput" placeholder="추가할 과목명을 입력하세요" value={categoryInput.subject} onChange={onChange}/>
                </InputBox>
