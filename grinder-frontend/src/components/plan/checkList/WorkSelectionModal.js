	...
	return (
		<ModalBackBlock>
			<ModalBlock>
				...
				{status === '' ? (
					<ModalContent>
						<div className="modalText">원하시는 작업을 선택하세요</div>
						<ButtonBlock>
							<ConfirmBtn onClick={() => onChangeStatus('update')}>
								수정
							</ConfirmBtn>
							<CancelBtn onClick={() => onChangeStatus('delete')}>
								삭제
							</CancelBtn>
						</ButtonBlock>
					</ModalContent>
					...
					<ModalContent>
						<div className="modalText">삭제되었습니다</div>
						<ButtonBlock>
